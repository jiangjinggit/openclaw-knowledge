...
## Start here
- 第一次了解本项目：看 `README.md` 和 `docs/NAVIGATION.md`
- 想直接搭模板：看 `SOUL.md`、`IDENTITY.md`、`USER.md`、`AGENTS.md`
- 想看变现路径：看 `docs/CONTENT_TRAINING_MONETIZATION.md`
- 想看产品层级：看 `docs/PRODUCT_LAYERS.md`
- 想看资产结构：看 `docs/ASSET_MAP.md`
- 想看具体可卖产品：看 `docs/OFFERS.md`
- 想看渠道联动：看 `docs/CONTENT_CHANNEL_STRATEGY.md`
- 想看用户分层：看 `docs/USER_SEGMENTS.md`
- 想看上线顺序：看 `docs/LAUNCH_SEQUENCE.md`
